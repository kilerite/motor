...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference("Maintenance.count") do
      post maintenances_url, params: { maintenance: { city_id: @maintenance.city_id, engine_id: @maintenance.engine_id, maintenance_date: @maintenance.maintenance_date, maintenance_type: @maintenance.maintenance_type, materials_id: @maintenance.materials_id, technician_email: @maintenance.technician_email } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { city_id: @maintenance.city_id, engine_id: @maintenance.engine_id, maintenance_date: @maintenance.maintenance_date, maintenance_type: @maintenance.maintenance_type, materials_id: @maintenance.materials_id, technician_email: @maintenance.technician_email } }
