...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference("Engine.count") do
      post engines_url, params: { engine: { description: @engine.description, engine_type: @engine.engine_type, name: @engine.name, photo: @engine.photo } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { description: @engine.description, engine_type: @engine.engine_type, name: @engine.name, photo: @engine.photo } }
